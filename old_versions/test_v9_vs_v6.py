"""Test V9 (Online Learning) vs V6 (Baseline Winner)"""

from monte_carlo_player import MonteCarloPlayer
from monte_carlo_v6_dynamic import MonteCarloV6Dynamic
from monte_carlo_v9_online_learning import MonteCarloV9OnlineLearning
...
if v9_wr > v6_wr:
    diff = (v9_wr - v6_wr) * 100
    print(f"\n🏆 V9 WINS by {diff:.1f}%!")
elif v6_wr > v9_wr:
    diff = (v6_wr - v9_wr) * 100
    print(f"\n🏆 V6 WINS by {diff:.1f}%!")
else:
    print(f"\n⚖️  TIED at {v6_wr:.1%}!")
