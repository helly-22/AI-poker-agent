"""Full test comparing BASELINE vs V6"""
...
def test_agent(agent_class, agent_name, num_games=20):
    """Test agent against all opponents"""
...
print("\n" + "=" * 70)
print("COMPREHENSIVE TEST: BASELINE vs V6 (Dynamic Trained)")
print("=" * 70)
print("20 games vs each of 8 opponents = 160 games per agent\n")

baseline_wr = test_agent(MonteCarloPlayer, "BASELINE (Hard-Coded)")
v6_wr = test_agent(MonteCarloV6Dynamic, "V6 (Dynamic Trained from JSON)")
