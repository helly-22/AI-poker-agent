"""Extended test V10 vs V6 (30 games per opponent)"""
...
def test_agent(agent_class, agent_name, num_games=30):
...
print("\n" + "=" * 70)
print("EXTENDED TEST: V6 vs V10 (30 games per opponent = 150 total)")
print("=" * 70)

v6_wr = test_agent(MonteCarloV6Dynamic, "V6 (Learned Thresholds)", num_games=30)
v10_wr = test_agent(MonteCarloV10AdvancedLearning, "V10 (40-Bucket + 40-Round)", num_games=30)
